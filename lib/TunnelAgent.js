...
class TunnelAgent extends Agent {
    constructor(options = {}) {
        ...
        // new tcp server.js to service requests for this client
    ...
    listen() {
        ...
        return new Promise((resolve) => {
            server.listen(() => {
                ...
                this.debug('tcp server.js listening on port: %d', port);
    ...
    _onConnection(socket) {
        ...
        socket.once('error', (err) => {
            ...
            // these are not actionable errors for our server.js
            socket.destroy();
        });
